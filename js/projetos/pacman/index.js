...
function circleColldesWithRectangle({circle,rectangle}) {
...
function animate() {
    ...
    ghosts.forEach(ghost => {
        ...
        const collisions = []
        boundaries.forEach(boundary => {
            if (!collisions.includes('right') && circleColldesWithRectangle({
                circle: {
                    ...ghost, velocity: {
                        x: ghost.speed,
                        y: 0
            ...
            if (!collisions.includes('left') && circleColldesWithRectangle({
                circle: {
                    ...ghost, velocity: {
                        x: -ghost.speed,
                        y: 0
            ...
            if (!collisions.includes('up') && circleColldesWithRectangle({
                circle: {
                    ...ghost, velocity: {
                        x: 0,
                        y: -ghost.speed
            ...
            if (!collisions.includes('down') && circleColldesWithRectangle({
                circle: {
                    ...ghost, velocity: {
                        x: 0,
                        y: ghost.speed
